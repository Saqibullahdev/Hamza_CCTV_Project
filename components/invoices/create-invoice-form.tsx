...
import { Trash2, Plus, ChevronDown, Loader2, Printer, ArrowLeft, Phone, MapPin, FileQuestion, FileText, Check } from "lucide-react"
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export function CreateInvoiceForm() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div ref={printRef} className="flex flex-col gap-6 print:gap-4 print:p-0 print:m-0 print:bg-white print:text-black">
